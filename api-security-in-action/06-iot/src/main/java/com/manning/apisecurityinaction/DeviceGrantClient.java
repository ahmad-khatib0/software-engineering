...
public class DeviceGrantClient {
    ...
    private static JSONObject beginDeviceAuthorization(
        ...
        var request = HttpRequest.newBuilder().header("Content-Type", "application/x-www-form-urlencoded")
                .uri(URI.create("https://as.example.com:8443/openam/oauth2/device/code"))
