...
/**
 * A rudimentary wrapper around the {@link SSLEngine} low-level DTLS protocol
 * state machine.
 * <p>
 * <strong>Note:</strong> this class doesn't attempt to handle timeouts, lost
 * packets, retransmissions, buffer overflows, and many other details of a
 * robust UDP-based protocol implementation. It implements enough to provide a
 * guidance to DTLS usage in Java. When used as a server, this class only
 * supports a single client at a time and will discard packets received from
