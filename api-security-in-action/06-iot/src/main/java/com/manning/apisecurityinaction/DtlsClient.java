...
public class DtlsClient {
    ...
    public static void main(String... args) throws Exception {
        try (var channel = new DtlsDatagramChannel(getClientContext(), sslParameters()); var in = Files.newBufferedReader(Paths.get("test.txt"))) {
            ...
            logger.info("Used cipher suite: {}", channel.getSession().getCipherSuite());
        }
    }
    ...
    private static SSLContext getClientContext() throws Exception {
        ...
        trustStore.load(new FileInputStream("as.example.com.ca.p12"), "changeit".toCharArray());
